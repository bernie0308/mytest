...
export const mediaOptions: Ref<Record<string, any>[]> = ref([])
...
export const columns: TableColumnsType = [
  ...
  { title: '媒体类型', dataIndex: 'media', key: 'media', minWidth: 260 },
  { title: '审核状态', dataIndex: 'approval', key: 'approval', minWidth: 120 },
